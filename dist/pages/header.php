  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="../pages/index.php" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
        ...
        <li class="pc-item">
          <a href="../pages/datausers.php" class="pc-link">
            <span class="pc-micon">
        ...
        <li class="pc-item">
          <a href="../pages/datadokter.php" class="pc-link">
            <span class="pc-micon">
              <i class="ti ti-users"></i>
            </span>
        ...
        <li class="pc-item">
          <a href="../pages/datastaff.php" class="pc-link">
            <span class="pc-micon">
              <i class="ti ti-users"></i>
            </span>
        ...
        <li class="pc-item">
          <a href="../pages/datapasien.php" class="pc-link">
            <span class="pc-micon">
              <i class="ti ti-users"></i>
            </span>
        ...
        <li class="pc-item">
          <a href="../pages/datarekammedis.php" class="pc-link">
            <span class="pc-micon">
        ...
        <li class="pc-item">
          <a href="../pages/datakontrol.php" class="pc-link">
            <span class="pc-micon">
              <i class="ti ti-report-medical"></i>
            </span>
            <span class="pc-mtext">Data Kontrol</span>
          </a>
        </li>
        ...
        <li class="pc-item">
          <a href="../pages/dataantrian.php" class="pc-link"
            ><span class="pc-micon">
              <i class="ti ti-report"></i></span
            ><span class="pc-mtext">Data Antrian</span></a
          >
        </li>
        <li class="pc-item">
          <a href="../pages/panggilanantrian.php" class="pc-link"
            ><span class="pc-micon">
              <i class="ti ti-report"></i></span
        ...
        <li class="pc-item">
          <a href="../pages/datatransaksi.php" class="pc-link"
            ><span class="pc-micon">
        ...
        <li class="pc-item">
          <a href="../pages/sign-in.php" class="pc-link"
            ><span class="pc-micon">
              <svg class="pc-icon">
        ...
        <div class="dropdown-body">
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
            <div class="d-flex mb-1">
              ...
              <div class="flex-grow-1 ms-3">
                <h6 class="mb-1">Juna Arka 🖖</h6>
                <span>junaarka@gmail.com</span>
              </div>
            </div>
